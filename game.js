// game.js - With Monk Class Implementation
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const CLASS_DATA = {
        ...
        // NEW: Monk class - tactical fighter with Arts (0 MP abilities)
    ...
    // NEW: Monk Arts (0 MP cost abilities)
       ...
       // Taunt: { level: 1, cost: 0, type: 'Art', effect: 'DrawAggro', target: 'self', turns: 1, alwaysFirst: true }
};
    ...
    const ENEMY_ARCHETYPES = {
        Weakling: { statMultipliers: { hp: 1.05, mp: 1.0, str: 1.1, def: 0.9, int: 1.0, mnd: 1.0 }, abilities: [] },
        Bruiser: { statMultipliers: { hp: 1.20, mp: 1.0, str: 1.2, def: 1.10, int: 1.0, mnd: 0.6 }, abilities: [] },
        Caster: { statMultipliers: { hp: 1.0, mp: 1.0, str: 1.1, def: 0.8, int: 1.30, mnd: 1.2 }, abilities: [] },
        Boss: { statMultipliers: { hp: 1.0, mp: 1.5, str: 2.0, def: 1.5, int: 1.3, mnd: 1.3 }, abilities: [] }
    };
    ...
    { weakling: { name: 'Rat', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Goblin', archetype: 'Bruiser', abilities: [{ name: "GoblinPunch", chance: 0.50, type: 'BruiserAbility' }] }, 
      caster: { name: 'Kobold', archetype: 'Caster', abilities: [{ name: "Pyro", chance: 0.41, type: 'Orison' }] } },
    { weakling: { name: 'Sand Worm', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Thief', archetype: 'Bruiser', abilities: [{ name: "Backstab", chance: 0.50, type: 'BruiserAbility' }] }, 
      caster: { name: 'Mummy', archetype: 'Caster', abilities: [{ name: "Lightning", chance: 0.50, type: 'Orison' }] } },
    { weakling: { name: 'Skeleton', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Ooze', archetype: 'Bruiser', abilities: [{ name: "AcidSplash", chance: 0.50, type: 'BruiserAbility' }] }, 
      caster: { name: 'Banshee', archetype: 'Caster', abilities: [{ name: "Freeze", chance: 0.70, type: 'Orison' }] } },
    { weakling: { name: 'Raptor', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Megasaurus', archetype: 'Bruiser', abilities: [{ name: "Stomp", chance: 0.50, type: 'BruiserAbility' }] }, 
      caster: { name: 'Nessiedon', archetype: 'Caster', abilities: [{ name: "Wave", chance: 0.70, type: 'Orison' }] } },
    { weakling: { name: 'Doomhound', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Dracoguard', archetype: 'Bruiser', abilities: [{ name: "Slash", chance: 0.75, type: 'BruiserAbility' }] }, 
      caster: { name: 'Elite Kobold', archetype: 'Caster', abilities: [{ name: "Pyro2", chance: 0.70, type: 'Orison' }] } },
    { weakling: { name: 'Mi-go', archetype: 'Weakling', abilities: [] }, 
      bruiser: { name: 'Shoggoth', archetype: 'Bruiser', abilities: [{ name: "Crush", chance: 1.00, type: 'BruiserAbility' }] }, 
      caster: { name: 'Elder Thing', archetype: 'Caster', abilities: [{ name: "Corruption", chance: 0.75, type: 'Orison' }] } }
];
...
class Character {
   ...
   takeDamage(amt) { 
    ...
    // Check for Dodge status (Monk ability)
...
const ENEMY_SPRITES = {
    'Rat': { src: 'https://i.imgur.com/e4JnC9d.png', width: 70, height: 70, fallbackText: 'Rat' },
    'Goblin': { src: 'https://i.imgur.com/Xcu9zE2.png', width: 80, height: 80, fallbackText: 'Gob' },
    'Kobold': { src: 'https://i.imgur.com/6pzi1E0.png', width: 80, height: 80, fallbackText: 'Kob' },
    'White Dragon': { src: 'https://i.imgur.com/CKrfmRI.png', width: 154, height: 154, fallbackText: 'Whi' },
    'Sand Worm': { src: 'https://i.imgur.com/xBJ4Zjs.png', width: 110, height: 110, fallbackText: 'San' },
    'Thief': { src: 'https://i.imgur.com/QdoIs9v.png', width: 90, height: 90, fallbackText: 'Thi' },
    'Mummy': { src: 'https://i.imgur.com/wYb4a7D.png', width: 90, height: 90, fallbackText: 'Mum' },
    'Blue Dragon': { src: 'https://i.imgur.com/K8Nf61W.png', width: 150, height: 150, fallbackText: 'Blu' },
    'Skeleton': { src: 'https://i.imgur.com/aqz2BhZ.png', width: 90, height: 90, fallbackText: 'Ske' },
    'Ooze': { src: 'https://i.imgur.com/bw5bxXL.png', width: 120, height: 120, fallbackText: 'Ooz' },
    'Banshee': { src: 'https://i.imgur.com/eDqsh10.png', width: 90, height: 90, fallbackText: 'Ban' },
    'Black Dragon': { src: 'https://i.imgur.com/BjClt4D.png', width: 150, height: 150, fallbackText: 'Bla' },
    'Raptor': { src: 'https://i.imgur.com/VzONkiC.png', width: 105, height: 105, fallbackText: 'Rap' },
    'Megasaurus': { src: 'https://i.imgur.com/JjFq2lP.png', width: 150, height: 150, fallbackText: 'Meg' },
    'Nessiedon': { src: 'https://i.imgur.com/iwR4yRM.png', width: 125, height: 125, fallbackText: 'Nes' },
    'Green Dragon': { src: 'https://i.imgur.com/4Jmsp45.png', width: 150, height: 150, fallbackText: 'Gre' },
    'Doomhound': { src: 'https://i.imgur.com/Qkp0tB0.png', width: 90, height: 90, fallbackText: 'Doo' },
    'Dracoguard': { src: 'https://i.imgur.com/cxRSWSh.png', width: 120, height: 120, fallbackText: 'Dra' },
    'Elite Kobold': { src: 'https://i.imgur.com/NEvOD5x.png', width: 95, height: 95, fallbackText: 'Eli' },
    'Red Dragon': { src: 'https://i.imgur.com/EEMmCrp.png', width: 150, height: 150, fallbackText: 'Red' },
    'Mi-go': { src: 'https://i.imgur.com/1QONqdF.png', width: 85, height: 85, fallbackText: 'Mig' },
    'Shoggoth': { src: 'https://i.imgur.com/VjFQY3g.png', width: 130, height: 130, fallbackText: 'Sho' },
    'Elder Thing': { src: 'https://i.imgur.com/CG48Kwh.png', width: 100, height: 100, fallbackText: 'Eld' },
    'King in Yellow': { src: 'https://i.imgur.com/vwJ9eBE.png', width: 150, height: 150, fallbackText: 'Kin' },
};
const PLAYER_SPRITES = {
    'Barbarian': { src: 'https://i.imgur.com/Id39qQz.png', width: 120, height: 120, fallbackText: 'BAR' },
    'Valkyrie': { src: 'https://i.imgur.com/2ZpPiAx.png', width: 100, height: 100, fallbackText: 'VAL' },
    'Ninja': { src: 'https://i.imgur.com/MjTiI3c.png', width: 100, height: 100, fallbackText: 'NIN' },
    'Shaman': { src: 'https://i.imgur.com/O0e0QCB.png', width: 110, height: 110, fallbackText: 'SHA' },
    'Sorceress': { src: 'https://i.imgur.com/sMfxdhj.png', width: 100, height: 100, fallbackText: 'SOR' },
    'Bishop': { src: 'https://i.imgur.com/tTO0Ell.png', width: 100, height: 100, fallbackText: 'BIS' },
    'Monk': { src: 'https://i.imgur.com/QG9vhk2.png', width: 100, height: 100, fallbackText: 'MNK' }
};
    // --- Game State Manager ---
    const gameState = {
    ...
    function calculateMagicDamage(caster, target, spellLvl) { const cI = caster.getCurrentStat ? caster.getCurrentStat('int') : caster.int; const tM = target.getCurrentStat ? target.getCurrentStat('mnd') : target.mnd; const rM = 1.5 + Math.random() * 0.45; const oV = ((caster.level + cI) * spellLvl) * rM; const dV = (target.level + tM); return Math.max(1, Math.round(oV - dV)); }
    ...
    function calculateHeal1Amount(caster) { const cI = caster.getCurrentStat ? caster.getCurrentStat('int') : caster.int; const pF = 1.2 * (caster.level + cI); const rM = 1.0 + Math.random() * 0.15; return Math.max(1, Math.round((pF * rM) + caster.level)); }
    function calculateOrisonDamage(caster, target) { const casterInt = caster.getCurrentStat ? caster.getCurrentStat('int') : caster.int; const targetMnd = target.getCurrentStat ? target.getCurrentStat('mnd') : target.mnd; const offenseValue = ((caster.level + casterInt) * 1.25) * (1.5 + Math.random() * 0.45); const defenseValue = (target.level + targetMnd); return Math.max(1, Math.round(offenseValue - defenseValue)); }
    // --- UI Update Functions ---
    function updatePartyStatusUI() {
        gameState.party.forEach((character, index) => {
            ...
            if (spriteElement) {
                spriteElement.style.bottom = '5px'; spriteElement.style.position = 'absolute'; spriteElement.style.transform = 'none';
    ...
    function updateEnemySpritesUI() {
        ...
        gameState.enemies.forEach((enemy, index) => {
            ...
            sprite.className = 'sprite enemy'; sprite.id = enemy.id;
            const totalEnemies = gameState.enemies.length;
            const spacing = totalEnemies <= 3 ? 25 : 18;
            sprite.style.left = `${20 + index * spacing}%`; sprite.style.top = '50%'; sprite.style.transform = 'translateY(-50%)'; sprite.style.position = 'absolute';
            ...
            if (spriteData) {
                ...
                spriteImg.src = spriteData.src; spriteImg.alt = enemy.type; spriteImg.className = 'enemy-sprite-img';
                spriteImg.onerror = () => { spriteImg.style.display = 'none'; sprite.textContent = spriteData.fallbackText || enemy.type.substring(0, 3); sprite.style.backgroundColor = 'rgba(128, 128, 128, 0.7)'; };
                sprite.appendChild(spriteImg); sprite.style.backgroundColor = 'transparent';
            ...
            if (enemy.statusEffects) { enemy.statusEffects.forEach(effect => { if (effect.type === 'Poison') sprite.classList.add('poisoned'); else if (effect.type === 'Slow') sprite.classList.add('slowed'); }); }
        ...
        gameState.party.forEach((character, index) => {
            const sprite = document.createElement('div');
            sprite.className = 'sprite party-member'; sprite.id = character.id + "-sprite";
            sprite.style.cssText = `left: ${20 + index * 20}% !important; bottom: 5px !important; position: absolute !important;`;
            const spriteData = PLAYER_SPRITES[character.className];
            if (spriteData) {
                if (spriteData.width && spriteData.height) { sprite.style.width = `${spriteData.width}px`; sprite.style.height = `${spriteData.height}px`; }
                const spriteImg = document.createElement('img');
                spriteImg.src = spriteData.src; spriteImg.alt = character.className; spriteImg.className = 'player-sprite-img';
                spriteImg.onerror = () => { spriteImg.style.display = 'none'; sprite.textContent = spriteData.fallbackText || character.className.substring(0, 3); sprite.style.backgroundColor = 'rgba(128, 128, 128, 0.7)'; };
                sprite.appendChild(spriteImg); sprite.style.backgroundColor = 'transparent';
    ...
    function updateDungeonBackground() { const bgElement = document.getElementById('game-background'); if (!bgElement) return; const dungeonIndex = Math.min(DUNGEON_BACKGROUNDS.length - 1, Math.floor((gameState.currentWave - 1) / 15)); const backgroundUrl = DUNGEON_BACKGROUNDS[dungeonIndex]; if (backgroundUrl) bgElement.style.backgroundImage = `url('${backgroundUrl}')`; else bgElement.style.backgroundImage = 'none'; }
    function updateProgressDisplay() { const progressDisplay = document.getElementById('progress-info-display'); const currentWaveSpan = document.getElementById('current-wave'); const dungeonNameDiv = document.getElementById('dungeon-name'); if (!progressDisplay || !currentWaveSpan || !dungeonNameDiv) return; if (gameState.currentState === 'PLAYER_COMMAND' || gameState.currentState === 'ACTION_RESOLUTION' || gameState.currentState === 'BETWEEN_WAVES') { progressDisplay.style.display = 'block'; } else { progressDisplay.style.display = 'none'; return; } const waveInDungeon = ((gameState.currentWave - 1) % 15) + 1; currentWaveSpan.textContent = waveInDungeon; const dungeonIndex = Math.floor((gameState.currentWave - 1) / 15); const dungeonNames = ["Overworld", "Desert", "Catacombs", "Jungle", "Badlands", "???"]; dungeonNameDiv.textContent = dungeonNames[dungeonIndex] || `Dungeon ${dungeonIndex + 1}`; }
    // --- Visual Effect Helpers ---
    function getCorrectElementId(actorOrTargetId) { if (gameState.party.some(p => p.id === actorOrTargetId)) return actorOrTargetId + "-sprite"; return actorOrTargetId; }
    function flashSprite(id, color = 'white', dur = 150) { 
        const elementId = getCorrectElementId(id); const element = document.getElementById(elementId); 
        if (element) {
            const flashEffect = document.createElement('div'); flashEffect.className = 'flash-effect';
            flashEffect.style.backgroundColor = color; flashEffect.style.opacity = '0.7'; 
            element.appendChild(flashEffect);
            setTimeout(() => { flashEffect.style.opacity = '0'; flashEffect.style.transition = `opacity ${dur/2}ms ease-out`; setTimeout(() => { if (element.contains(flashEffect)) element.removeChild(flashEffect); }, dur/2); }, dur/2);
        }
    }
    function shimmerSprite(id, color = 'gold', dur = 1400) { 
        const elementId = getCorrectElementId(id); const element = document.getElementById(elementId); 
        if (element) {
            const shimmerDiv = document.createElement('div'); shimmerDiv.className = 'shimmer-effect';
    ...
    function showFloatingNumber(targetId, amount, type = 'damage') { 
        const elementId = getCorrectElementId(targetId); const tE = document.getElementById(elementId); if (!tE) return; 
        const nE = document.createElement('span'); nE.textContent = Math.abs(amount); nE.className = `floating-number ${type}`; 
        const cont = document.getElementById('game-container'); const targetRect = tE.getBoundingClientRect(); const contRect = cont.getBoundingClientRect(); 
        let sX = targetRect.left - contRect.left + (targetRect.width / 2); let sY = targetRect.top - contRect.top; sX += Math.random() * 20 - 10; 
        nE.style.left = `${sX - 15}px`; nE.style.top = `${sY}px`; cont.appendChild(nE); 
        nE.addEventListener('animationend', () => { if (nE.parentNode === cont) cont.removeChild(nE); }, { once: true }); 
    }
    let announcementTimeout = null; 
    function showActionAnnouncement(text, duration = 1500) { const bar = document.getElementById('action-announcement-bar'); const barText = document.getElementById('action-announcement-text'); if (!bar || !barText) return; if (announcementTimeout) clearTimeout(announcementTimeout); barText.textContent = text; bar.style.display = 'block'; announcementTimeout = setTimeout(() => { bar.style.display = 'none'; announcementTimeout = null; }, duration); }
    function applyCastingAnimation(actorId, castType, duration = 1000) { const elementId = getCorrectElementId(actorId); const element = document.getElementById(elementId); if (element) { element.classList.remove('casting-spell', 'casting-prayer', 'casting-rage', 'casting-fire', 'casting-frost', 'casting-shock', 'casting-hydro', 'casting-dragon-breath', 'casting-focus', 'casting-rapid', 'casting-zen'); element.classList.add(`casting-${castType}`); setTimeout(() => { if (element) element.classList.remove(`casting-${castType}`); }, duration); } }

    // --- Initialization Function ---
   function initializeGame() { gameState.currentWave = 0; gameState.currentDungeon = 0; gameState.messageLog = []; gameState.party = []; gameState.enemies = []; gameState.nextWaveEffect = null; gameState.partySelectionIndex = 0; gameState.selectedClasses = [null, null, null, null]; gameState.tempSelectedClass = CLASS_LIST[0]; gameState.activeMenu = 'main'; gameState.focusedIndex = 0; gameState.actionQueue = []; const bgElement = document.getElementById('game-background'); if (bgElement) bgElement.style.backgroundImage = 'none'; gameState.setState('TITLE_SCREEN'); setupGlobalKeyListener(); }
   ...
   function populateMenu(menuType, associatedData = null) {
    ...
    switch (menuType) {
        case 'main': 
            menuContainer.className = 'action-menu-box'; const char = gameState.party[gameState.activeCharacterIndex]; 
            if (char) { ['Attack', 'Spell', 'Prayer', 'Rage', 'Arts'].forEach(cmd => { 
                ...
                if (available) { const btn = document.createElement('button'); btn.dataset.action = cmd; btn.textContent = cmd; menuContainer.appendChild(btn); } 
            }); updateActionMenuUI(char); } break;
        case 'Spell': case 'Prayer': 
            menuContainer.className = 'sub-menu-box'; const caster = gameState.party[gameState.activeCharacterIndex]; 
            const powerList = caster.powers.filter(p => POWER_DATA[p]?.type === (menuType === 'Spell' ? 'Spell' : 'Prayer')); 
            if (powerList.length > 0) { powerList.forEach(pN => { const p = POWER_DATA[pN]; const btn = document.createElement('button'); btn.dataset.power = pN; btn.textContent = `${pN} (${p.cost} MP)`; btn.disabled = caster.currentMp < p.cost; menuContainer.appendChild(btn); }); } 
            else { menuContainer.innerHTML = `<p style="color: #aaa;">No ${menuType} known.</p>`; const backBtn = document.createElement('button'); backBtn.textContent = "Back"; backBtn.onclick = handleMenuCancel; menuContainer.appendChild(backBtn); } break;
        case 'Arts':
            menuContainer.className = 'sub-menu-box'; const monk = gameState.party[gameState.activeCharacterIndex]; 
            const artsList = monk.powers.filter(p => POWER_DATA[p]?.type === 'Art'); 
            if (artsList.length > 0) { artsList.forEach(pN => { const btn = document.createElement('button'); btn.dataset.power = pN; btn.textContent = `${pN} (0 MP)`; btn.disabled = false; menuContainer.appendChild(btn); }); } 
            else { menuContainer.innerHTML = `<p style="color: #aaa;">No Arts known.</p>`; const backBtn = document.createElement('button'); backBtn.textContent = "Back"; backBtn.onclick = handleMenuCancel; menuContainer.appendChild(backBtn); } break;
        case 'targets': 
            menuContainer.className = 'sub-menu-box target-menu'; const targetEnemies = associatedData; const prompt = document.createElement('span'); prompt.id = 'target-prompt'; prompt.textContent = `Select Target (${targetEnemies ? 'Enemy' : 'Ally'}):`; menuContainer.appendChild(prompt); 
            const list = targetEnemies ? gameState.enemies : gameState.party; const pName = gameState.currentAction?.powerName; const power = pName ? POWER_DATA[pName] : null; let found = false; 
            list.forEach(t => { let valid = false; if (targetEnemies) { valid = t.isAlive; } else { if (power?.target === 'ally_ko') valid = !t.isAlive; else if (pName === 'Miracle') valid = true; else valid = t.isAlive; } 
            if (valid) { found = true; const b = document.createElement('button'); b.dataset.targetId = t.id; b.textContent = t.name + (pName === 'Miracle' && !t.isAlive ? ' (KO)' : ''); menuContainer.appendChild(b); } }); 
            if (!found) { menuContainer.innerHTML += `<p style="color: #aaa;">No valid targets.</p>`; const backBtn = document.createElement('button'); backBtn.textContent = "Back"; backBtn.onclick = handleMenuCancel; menuContainer.appendChild(backBtn); } break;
    }
    contentArea.appendChild(menuContainer); resetFocusToMenu(menuType);
}
    // --- Event Listeners & Input Handling ---
    function setupGlobalKeyListener() { document.removeEventListener('keydown', handleGlobalKeyPress); document.addEventListener('keydown', handleGlobalKeyPress); }
    ...
    function setupCombatButtonListeners() { const contentArea = document.getElementById('dynamic-menu-content'); if (contentArea) { contentArea.removeEventListener('click', handleCombatButtonClick); contentArea.addEventListener('click', handleCombatButtonClick); } }
    ...
    function handleMenuCancel() { switch (gameState.activeMenu) { case 'Spell': case 'Prayer': case 'Arts': populateMenu('main'); gameState.currentAction = null; break; case 'targets': const aT = gameState.currentAction?.type; if (aT === 'Spell') populateMenu('Spell'); else if (aT === 'Prayer') populateMenu('Prayer'); else if (aT === 'Art') populateMenu('Arts'); else { populateMenu('main'); gameState.currentAction = null; } break; case 'main': break; } }
    function resetFocusToMenu(menuName) { gameState.activeMenu = menuName; const menuEl = document.querySelector('#dynamic-menu-content > div'); if (menuEl) { const btns = getVisibleEnabledButtons(menuEl); if (btns.length > 0) { gameState.focusedIndex = 0; updateMenuFocus(btns, 0); } else { gameState.focusedIndex = -1; } } else { gameState.focusedIndex = -1; } }

    // --- Action Handling ---
    function handleActionClick(button) { const aT = button.dataset.action; const char = gameState.party[gameState.activeCharacterIndex]; if (!char || !char.isAlive || button.disabled) return; gameState.currentAction = { type: aT, casterId: char.id, targets: [] }; switch (aT) { case 'Attack': case 'Rage': populateMenu('targets', true); break; case 'Spell': populateMenu('Spell'); break; case 'Prayer': populateMenu('Prayer'); break; case 'Arts': populateMenu('Arts'); break; default: populateMenu('main'); } }
   function handlePowerSelection(button) { 
    const pN = button.dataset.power; const p = POWER_DATA[pN]; const caster = gameState.party[gameState.activeCharacterIndex]; 
    if (!p || (p.cost > 0 && caster.currentMp < p.cost)) { gameState.addLogMessage(`${caster.name} needs more MP for ${pN}!`); return; } 
    gameState.currentAction.powerName = pN; gameState.currentAction.powerCost = p.cost; gameState.currentAction.type = p.type;
    if (p.target === 'enemies' || p.target === 'allies' || p.target === 'all_enemies' || p.target === 'random_enemies') { 
        ...
        queueAction(caster.id, gameState.currentAction); gameState.currentAction = null; highlightActivePartyStatus(-1); prepareCommandPhase(); 
    } else if (p.target === 'self') {
        gameState.currentAction.targets = [caster.id];
        queueAction(caster.id, gameState.currentAction); gameState.currentAction = null; highlightActivePartyStatus(-1); prepareCommandPhase();
    } else { 
        const targetsEnemies = p.target === 'enemy' || p.target === 'enemies'; populateMenu('targets', targetsEnemies); 
    } 
}
    function handleTargetSelection(button) { const tId = button.dataset.targetId; gameState.currentAction.targets = [tId]; if (gameState.currentState === 'PLAYER_COMMAND') { const act = gameState.currentAction; const cast = gameState.getCharacterById(act.casterId); queueAction(cast.id, act); gameState.currentAction = null; highlightActivePartyStatus(-1); prepareCommandPhase(); } }

    // --- Core Game Logic ---
function finalizePartySelection() { 
    gameState.party = []; 
    gameState.selectedClasses.forEach((cN, i) => { if (!cN) cN = 'Barbarian'; const c = new Character(`party-${i + 1}`, cN); const TESTING_START_LEVEL = 1; for (let level = 1; level <= TESTING_START_LEVEL; level++) { c.applyLevelUpGrowth(level); } c.fullRestore(); gameState.party.push(c); }); 
    gameState.setState('COMBAT_LOADING'); setupCombatButtonListeners(); startNextWave(); 
}
   function startNextWave() { 
    gameState.currentWave++; gameState.addLogMessage(`Wave ${gameState.currentWave}`); 
    gameState.party.forEach(c => { if (c.isRaging) c.isRaging = false; });
    updateDungeonBackground(); updateProgressDisplay();
    gameState.enemies = generateEnemiesForWave(gameState.currentWave); 
    gameState.actionQueue = []; gameState.nextWaveEffect = null; gameState.activeCharacterIndex = 0; 
    gameState.setState('PLAYER_COMMAND'); prepareCommandPhase(); 
}
function generateEnemiesForWave(wave) { 
    const enemies = []; const dungeonIndex = Math.min(DUNGEON_ENEMIES.length - 1, Math.floor((wave - 1) / 15)); 
    const waveIndexInDungeon = (wave - 1) % 15; const dungeonData = DUNGEON_ENEMIES[dungeonIndex]; 
    const baseStats = calculateEnemyStats(wave); let isBossWave = (waveIndexInDungeon === 14); let compositionString = ""; 
    ...
    if (isBossWave) { 
        ...
        if (dungeonIndex === 0) bossName = 'White Dragon'; else if (dungeonIndex === 1) bossName = 'Blue Dragon'; 
        else if (dungeonIndex === 2) bossName = 'Black Dragon'; else if (dungeonIndex === 3) bossName = 'Green Dragon';
        else if (dungeonIndex === 4) bossName = 'Red Dragon'; else if (dungeonIndex === 5) bossName = 'King in Yellow';
        const multipliers = ENEMY_ARCHETYPES['Boss'].statMultipliers; 
        let finalStats = { hp: Math.round(baseStats.hp * 2.85), mp: Math.round(baseStats.mp * multipliers.mp), str: Math.round(baseStats.str * multipliers.str), def: Math.round(baseStats.def * multipliers.def), int: Math.round(baseStats.int * multipliers.int), mnd: Math.round(baseStats.mnd * multipliers.mnd) }; 
        ...
        for (let i = 0; i < compositionString.length; i++) { 
            ...
            if (typeChar === 'W') enemyDef = dungeonData.weakling; else if (typeChar === 'B') enemyDef = dungeonData.bruiser; else if (typeChar === 'C') enemyDef = dungeonData.caster; else continue; 
            ...
            letterCounts[typeChar]++; const enemyName = `${enemyDef.name} ${String.fromCharCode(64 + letterCounts[typeChar])}`; 
...
function calculateEnemyStats(wave) { let hp = 15, mp = 10, s = 4, d = 4, i = 4, m = 4; const bonusIncrements = Math.floor((wave - 1) / 15); for (let n = 1; n < wave; n++) { hp = Math.round(hp * 1.077); mp = Math.round(mp * 1.12); s++; d++; i++; m++; } s += bonusIncrements * 5; d += bonusIncrements * 5; i += bonusIncrements * 5; m += bonusIncrements * 5; return { hp, mp, str: s, def: d, int: i, mnd: m }; }
function prepareCommandPhase() {
    if (gameState.currentState !== 'PLAYER_COMMAND') return;
    let found = false; let startIdx = gameState.activeCharacterIndex;
    for (let i = 0; i < gameState.party.length; i++) {
        let checkIdx = (startIdx + i) % gameState.party.length;
        const char = gameState.party[checkIdx];
        if (char.isAlive && !gameState.actionQueue.some(item => item.actorId === char.id)) { gameState.activeCharacterIndex = checkIdx; found = true; break; }
    }
    if (found) { const char = gameState.party[gameState.activeCharacterIndex]; gameState.addLogMessage(`--- ${char.name}, command? ---`); populateMenu('main'); highlightActivePartyStatus(gameState.activeCharacterIndex); document.getElementById('action-menu-area').style.display = 'flex'; }
    else { queueEnemyActions(); }
}
    function queueAction(actorId, actionDetails) { 
        const actor = gameState.getCharacterById(actorId) || gameState.getEnemyById(actorId); if (!actor) return; 
    ...
    // --- Queue Enemy Actions with Taunt support ---
    function queueEnemyActions() { 
        // Check for Monk with Taunt status
        ...
        gameState.enemies.forEach(enemy => { 
            if (enemy.isAlive) { 
                ...
                if (alivePlayers.length > 0) { 
                    ...
                    // Determine target - Taunt redirects Weakling and Bruiser attacks
                    let targetPlayer;
    ...
    function startActionResolution() { 
        ...
        gameState.actionQueue.forEach(i => { 
            ...
            // Tier 1: Always First (Rapid, Dodge, Taunt)
            if (power?.alwaysFirst) {
                i.priorityTier = 1;
            }
            // Tier 2: Dragon Breath / Annihilate (Boss priority)
            else if (i.action.type === 'DragonBreath' || i.action.type === 'Annihilate') {
                i.priorityTier = 2;
            }
            // Tier 4: Always Last (Focus)
            else if (power?.alwaysLast) {
                i.priorityTier = 4;
            }
            // Tier 3: Normal actions
            else {
                i.priorityTier = 3;
            }
        }); 
        
        // Sort by priority tier first, then speed roll
        gameState.actionQueue.sort((a, b) => { 
            // Sort by priority tier first
            if (a.priorityTier !== b.priorityTier) return a.priorityTier - b.priorityTier;
            // Then by speed roll (higher goes first)
            if (b.speedRoll !== a.speedRoll) return b.speedRoll - a.speedRoll; 
            // Players go after enemies within same tier
    ...
    function executeNextQueuedAction() {
        ...
        // Arts have 0 cost, no MP check needed
        ...
        // Apply animations based on action type
        switch (action.type) {
    ...
    function performArt(actor, artName, resolvedTargets) {
        ...
        switch (artData.effect) {
            case 'EnhancedStrike': // Focus
                performFocus(actor, resolvedTargets[0], empowerBuff, hasFury, lifelinkBuff);
                break;
            case 'DoubleAttack': // Rapid
                performRapid(actor, empowerBuff, hasFury, lifelinkBuff);
                break;
            case 'SelfHeal': // Zen
                performZen(actor);
                break;
            case 'Evasion': // Dodge
                performDodge(actor);
                break;
            case 'AOE_Attack': // Kick
                performKick(actor, empowerBuff, lifelinkBuff);
                break;
            case 'DrawAggro': // Taunt
                performTaunt(actor);
                break;
        }
    }
    
    // --- Focus: High damage, always last ---
    function performFocus(actor, target, empowerBuff, hasFury, lifelinkBuff) {
        ...
        // Calculate damage with Focus multiplier
        let baseDamage = calculatePhysicalDamage(actor, target);
        let focusDamage = Math.round(baseDamage * focusMultiplier);
        
        // Apply Empower
        if (empowerBuff?.damageMultiplier) {
            focusDamage = Math.round(focusDamage * empowerBuff.damageMultiplier);
            gameState.addLogMessage(`${actor.name}'s Focus is empowered!`);
        }
        ...
        setTimeout(() => {
            ...
            if (target.currentHp <= 0) { target.currentHp = 0; target.isAlive = false; gameState.addLogMessage(`${target.name} defeated!`); }
    ...
    // --- Rapid: 2 hits (4 with Fury), always first ---
    function performRapid(actor, empowerBuff, hasFury, lifelinkBuff) {
        const rapidMultiplier = POWER_DATA['Rapid'].damageMultiplier; // 0.75
        ...
        for (let i = 0; i < totalHits; i++) {
            setTimeout(() => {
                ...
                if (empowerBuff?.damageMultiplier) {
                    rapidDamage = Math.round(rapidDamage * empowerBuff.damageMultiplier);
                }
    ...
    function performZen(actor) {
        const healPercent = POWER_DATA['Zen'].healPercent; // 0.33
    ...
    // --- Dodge: Immunity for 1 round ---
    function performDodge(actor) {
        actor.addStatus({ type: 'Dodge', turns: 1 });
        gameState.addLogMessage(`${actor.name} prepares to dodge all attacks!`);
        shimmerSprite(getCorrectElementId(actor.id), 'cyan', 800);
        updatePartyStatusUI();
        updateEnemySpritesUI();
    }
    
    // --- Kick: AOE attack, no Fury bonus ---
    function performKick(actor, empowerBuff, lifelinkBuff) {
        const kickMultiplier = POWER_DATA['Kick'].damageMultiplier; // 1.0
        ...
        targets.forEach((target, index) => {
            setTimeout(() => {
                ...
                if (empowerBuff?.damageMultiplier) {
                    kickDamage = Math.round(kickDamage * empowerBuff.damageMultiplier);
                }
    ...
    // --- Taunt: Force enemies to target Monk ---
    function performTaunt(actor) {
        actor.addStatus({ type: 'Taunt', turns: 1 });
        gameState.addLogMessage(`${actor.name} taunts all enemies!`);
        shimmerSprite(getCorrectElementId(actor.id), 'red', 800);
        updatePartyStatusUI();
        updateEnemySpritesUI();
    }
    // --- Perform Attack ---
   function performAttack(c, t) { 
    ...
    setTimeout(() => { 
        ...
        else { t.currentHp -= dmg; actualDamageTaken = dmg; if (t.currentHp <= 0) { t.currentHp = 0; t.isAlive = false; } } 
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        ...
                        else { t.currentHp -= dmg2; actualDamage2 = dmg2; if (t.currentHp <= 0) { t.currentHp = 0; t.isAlive = false; } }
    ...
    // --- Perform Orison (Enemy Caster spell) ---
        ...
        if (p.element) { 
            ...
            setTimeout(() => {
                ...
                setTimeout(() => { 
                    ...
                    else { t.currentHp -= dmg; if (t.currentHp <= 0) { t.currentHp = 0; t.isAlive = false; gameState.addLogMessage(`${t.name} defeated!`); } updateEnemySpritesUI(); } 
            ...
            if (!t.isAlive) { t.isAlive = true; const hp = Math.round(t.maxHp * p.hpPercent); t.heal(hp); showFloatingNumber(targetElementId, hp, 'heal'); gameState.addLogMessage(`${t.name} revived!`); updatePartyStatusUI(); } 
            else { gameState.addLogMessage(`${t.name} alive.`); } highlightActivePartyStatus(-1); 
        } 
            ...
            else { gameState.addLogMessage(`${t.name} resists.`); } highlightActivePartyStatus(-1); 
        } 
  ...
  function handleWinWave() { 
    ...
    updatePartyStatusUI(); 
    if (gameState.currentWave % 15 === 0) gameState.setState('TAVERN'); 
    else gameState.setState('BETWEEN_WAVES'); 
}
    
    function handleItemChoice(e) { const iN = e.currentTarget.dataset.item; gameState.addLogMessage(`Chosen: ${iN}`); applyItemEffect(iN); gameState.setState('COMBAT_LOADING'); startNextWave(); }
   
    function showItemRewardScreen() { 
        const o = document.getElementById('item-options'); o.innerHTML = ''; 
        const i1 = 'Potion'; let i2 = ''; const r = Math.random(); 
        if (r < 0.49) i2 = 'Serum'; else i2 = 'Scroll'; 
        [i1, i2].forEach(iN => { const b = document.createElement('button'); b.dataset.item = iN; b.textContent = iN; b.addEventListener('click', handleItemChoice); o.appendChild(b); }); 
    }
  ...
  function enterTavern() { 
    ...
    gameState.party.forEach(c => { const wasAlive = c.isAlive; c.fullRestore(); if (!wasAlive) gameState.addLogMessage(`${c.name} revived!`); }); 
    gameState.addLogMessage("Party fully restored!"); 
    updatePartyStatusUI(); updateEnemySpritesUI();
    
    const area = document.getElementById('class-change-area'); area.innerHTML = ''; 
    gameState.party.forEach((c, i) => { 
        const d = document.createElement('div'); d.style.marginBottom = '10px'; 
        const l = document.createElement('span'); l.textContent = `Char ${i + 1}(${c.name}): `; d.appendChild(l); 
        const s = document.createElement('select'); s.id = `class-select-${i + 1}`; s.dataset.characterIndex = i; 
        Object.keys(CLASS_DATA).forEach(cN => { const o = document.createElement('option'); o.value = cN; o.textContent = cN; if (cN === c.className) o.selected = true; s.appendChild(o); }); 
        d.appendChild(s); area.appendChild(d); 
    }); 
    const b = document.getElementById('proceed-button'); b.replaceWith(b.cloneNode(true)); 
    ...
    function handleTavernProceed() {
        gameState.party.forEach((character, index) => {
            ...
            if (selectElement) {
                ...
                if (newClassName !== character.className) {
                    ...
                    character.className = newClassName; character.name = newClassName;
        ...
        gameState.setState('COMBAT_LOADING'); startNextWave();
    }
    
    function handleGameOver() { 
        gameState.addLogMessage("Party fallen..."); 
        const b = document.getElementById('restart-button'); b.replaceWith(b.cloneNode(true)); 
